ALTER TABLE public.watch
    ADD CONSTRAINT watch_fk FOREIGN KEY (employee_id) REFERENCES public.employee (id);
...
ALTER TABLE public.preferred_day
    ADD CONSTRAINT preferred_day_fk FOREIGN KEY (employee_id) REFERENCES public.employee (id);

ALTER TABLE public.off_day
    ADD CONSTRAINT off_day_fk FOREIGN KEY (employee_id) REFERENCES public.employee (id);

ALTER TABLE public.manager
    ADD CONSTRAINT manager_fk FOREIGN KEY (user_id) REFERENCES public."user" (id);
...
ALTER TABLE public.employee
    ADD CONSTRAINT employee_fk_2 FOREIGN KEY (user_id) REFERENCES public."user" (id);
